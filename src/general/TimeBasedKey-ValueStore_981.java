...
class TimeBasedKey-ValueStore_981 {
    ...
    public void set(String key, String value, int timestamp) {
        TreeMap<Integer, String> in = out.getOrDefault(key, new TreeMap<Integer, String>());
        in.put(timestamp, value);
        out.put(key, in);
    }
    
    public String get(String key, int timestamp) {
        TreeMap<Integer, String> in = out.get(key);
        if (in==null) return "";
        return in.floorEntry(timestamp)==null? "":in.floorEntry(timestamp).getValue();
    }
}
